...
export enum CompanyTitle {
    ...
    OVERSEA_PARTNER = 'Overseas Partner'
}
...
export enum ReportType {
    ...
    ProjectedOutgoingInvoice = 'ProjectedOutgoingInvoice',
    OfferMonitorReport = 'OfferMonitorReport',
    ExtendedReportForProjectedInvoices =  'ExtendedReportForProjectedInvoices'//  EXTENDED_REPORT_FOR_PROJECTED_INVOICES
